...
In this talk I presented results on the topology of oxide glasses extracted using persistent homology with a foucus on void structure. These results are published in [Revealing the void-size distribution of silica glass using persistent homology](https://doi.org/10.1016/j.mtla.2025.102613), *Materialia* **44** (2025).
